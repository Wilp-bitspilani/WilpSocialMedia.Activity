...
{
    public partial class Wilpsocialmedia_ActivityContext : DbContext
    {
        public Wilpsocialmedia_ActivityContext(DbContextOptions<Wilpsocialmedia_ActivityContext> options)
            : base(options)
        {
